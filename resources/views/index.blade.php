    ...
    <section id="home" class="pt-36 pb-70 h-screen">  <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 items-center">
            <div class="mt-24">
                ...
                <a href="#"
                    class="text-base font-semibold text-white bg-black py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">Hubungi
                    Saya</a>
            </div>
        </div>
    </div>
    ...
    <div class="px-16">
        ...
        <div class="w-full flex flex-wrap justify-center">
            ...
            <div class="mb-12 p-4 md:w-1/2">
                <div class="rounded-md shadow-md overflow-hidden">
                    <a href="{{ url('/news') }}">
                        <img src="/img/nyadran1.jpeg" alt="Konveksi Desa Muncang" class="w-full">
                    </a>
                </div>
            ...
            <div class="mb-12 p-4 md:w-1/2">
                <div class="rounded-md shadow-md overflow-hidden">
                    <a href="{{ url('/news') }}">
                        <img src="/img/nyadran3.jpeg" alt="Peternakan Desa Muncang" class="w-full">
                    </a>
                </div>
        ...
        <div class="px-16">
            <div class="w-full">
                <div class="mx-auto text-center mb-16">
                    ...
                    <h2 class="font-semibold text-white text-3xl mb-4 sm:text-4xl lg:text-5xl">Kata Mereka
                    </h2>
                    <p class="font-semibold text-md text-secondary md:text-lg">Kesan Pesan terhadap KKN Tim II Undip 2023/2024
                    </p>
                </div>
            </div>
