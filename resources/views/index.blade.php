...
<body>
    ...
    <!-- Hero Section Start -->
    <section id="home" class="pt-36 pb-70 h-screen">  <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 items-center">
            <div class="mt-24">
                <h1 class="text-base font-semibold text-primary md:text-xl">Selamat Datang di <span
                        class="block font-bold text-dark text-4xl mb-6">Website Profil Desa Muncang</span></h1>
                <h2 class="font-semibold text-secondary text-lg"><span>
                <a href="#contact" class="text-base font-semibold text-white bg-black py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">Explore</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="px-16">
        ...
        <div class="w-full flex flex-wrap justify-center">
            ...
            <div class="mb-12 p-4 md:w-1/2">
                <div class="rounded-md shadow-md overflow-hidden">
                    <a href="{{ url('/news') }}">
                        <img src="/img/konveksi1.jpg" alt="Konveksi Desa Muncang" class="w-full">
                    </a>
                </div>
                <h3 class="font-semibold text-xl text-dark mt-5 mb-3">Konveksi Desa Muncang</h3>
                <p class="font-medium text-base text-secondary">Konveksi adalah mata pencaharian utama warga desa Muncang. Hampir di setiap rumah di desa Muncang berisi 1 buruh jahit.</p>
            </div>
            <div class="mb-12 p-4 md:w-1/2">
                <div class="rounded-md shadow-md overflow-hidden">
                    <a href="{{ url('/news') }}">
                        <img src="/img/ternak1.jpg" alt="Peternakan Desa Muncang" class="w-full">
                    </a>
                </div>
                <h3 class="font-semibold text-xl text-dark mt-5 mb-3">Peternakan Desa Muncang</h3>
                <p class="font-medium text-base text-secondary">Berikut merupakan peternakan ayam milik warga, ini merupakan salah satu mata pencaharian warga desa muncang.</p>
            </div>
        </div>
    </div>
</section>
<!-- About Section End -->
    ...
    <section id="contact" class="pt-36 pb-32 h-screen">  <div class="container">
            <div class="flex flex-wrap item-center">
                <div class="w-full mb-10 lg:w-1/2 item-center px-16">
                    ...
                    <p class="font-med text-base text-secondary max-w-xl lg:text-lg">Secara umum, potensi yang ada dari
                        Desa Muncang adalah dalam sektor pertanian dan konveksi. Bidang pertanian dengan penggunaan
                        sawah seluas 265 Ha dengan komoditas utama tanaman padi.</p>
                </div>
                <div class="w-full lg:w-1/2 px-16">
                    <h3 class="font-semibold text-dark text-2xl mb-4 lg:text-3xl lg:pt-10">Cari Kami</h3>
                    <p class="font-med text-base text-secondary mb-6 lg:text-lg"></p>
                    <div class="flex items-center">
                        <!-- Youtube -->
                        <a href="https://www.youtube.com/@diwai2025/featured" target="_blank"
