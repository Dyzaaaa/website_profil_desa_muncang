...
<div class="relative min-h-screen bg-gray-100">
    ...
    <div class="flex justify-center items-center pt-5 pb-16">
        <div id="gallery" class="relative w-full md:w-3/4 lg:w-2/3 h-[80vh]" data-carousel="static">
            ...
            <!-- Slider controls -->
            <button type="button" class="absolute top-1/2 start-0 z-30 flex items-center justify-center h-10 w-10 cursor-pointer group focus:outline-none transform -translate-y-1/2" data-carousel-prev>
...
<button type="button" class="absolute top-1/2 end-0 z-30 flex items-center justify-center h-10 w-10 cursor-pointer group focus:outline-none transform -translate-y-1/2" data-carousel-next>
    <span class="inline-flex items-center justify-center w-full h-full rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
        <svg class="w-4 h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
